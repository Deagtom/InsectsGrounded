...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(InsectsGrounded.MODID);

    private static <T extends Block> DeferredBlock<T> _registerBlock(String name, Supplier<T> block) {
        DeferredBlock<T> toReturn = BLOCKS.register(name, block);
        _registerBlockItem(name, toReturn);
        return toReturn;
    }

    private static <T extends Block> void _registerBlockItem(String name, DeferredBlock<T> block) {
